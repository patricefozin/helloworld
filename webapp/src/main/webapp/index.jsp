<h1> Hello, Welcome to Simple DevOps Project Patrice Fozin !! </h1>
<h1> It is great to see that you have achieved this level </h1>
<h2> Data Service Group is your learning partner and is always happy to 
...
<h1> Buildding the image is done from the localhost, not the target server </h1>
